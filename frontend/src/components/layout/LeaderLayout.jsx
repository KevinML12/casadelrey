      ...
      <div className="px-5 py-6 border-b border-white/10">
        <Link to="/leader" onClick={onClose} className="flex items-center gap-2.5 group">
          ...
          <div className="min-w-0">
            ...
            <p className="text-[10px] font-extrabold uppercase tracking-widest text-celeste-hov mt-0.5">Panel Líder</p>
          </div>
        </Link>
      </div>
    ...
    <div className="relative flex h-screen bg-bg overflow-hidden text-ink">
      ...
      <div className="flex flex-col flex-1 min-w-0 relative z-10">
        <div className="md:hidden h-14 border-b border-white/10 liquid-glass rounded-none flex items-center px-4 gap-3 shrink-0">
          ...
          <span className="text-[14.5px] text-white font-extrabold tracking-tightish">Panel Líder</span>
        </div>
