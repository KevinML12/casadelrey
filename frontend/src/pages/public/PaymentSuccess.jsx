  ...
  return (
    <div className="min-h-screen bg-bg flex items-center justify-center p-6">
      <Reveal className="text-center max-w-sm liquid-glass rounded-[28px] p-10">
        ...
        <h1 className="text-22 font-bold text-white mb-2">¡Donación registrada!</h1>
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link to="/" className="inline-flex items-center justify-center gap-2.5 px-6 py-3.5 rounded-pill bg-white text-bg font-bold text-14">
